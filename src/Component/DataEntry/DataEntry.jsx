...
import { whitevariationSvg, FolderSvg,Offsets, CircleSvg, GreenSvg, Co2, PiechartSvg, AddIcon, User, Leftarrow, Layer1, Layer2, Layer3 } from "./../../assets";
...
const DataEntry = () => {
  ...
  const rowCount = rows.length;
        ...
        return rows.map((rowData, index) => (
            <div className='row-bar' key={index}>
                <div className="data-row">
                    <input type="text" placeholder="Description of Project" className="mobile-combustion-data-entry-child1-vehicle" value={rowData.Description}  />
                    
                    <input className="mobile-combustion-data-entry-child3-consumption" type="text" placeholder="Less Emissions in MTCO2 " value={rowData.EmissionOffset}  />
                    
                    <input className="mobile-combustion-data-entry-child4-si" type="text" placeholder="Location Offset Carried out" value={rowData.Location} />
                    <input className="mobile-combustion-data-entry-child2-fuel" type="text" placeholder="Select type of Offset" value={rowData.TypeofOffset}  />
    ...
    return (
      ...
      <div className="fuel1">EMISSIONS OFFSET</div>

      <div className="Units">LOCATION</div>
      <b className="type-of-offset">TYPE OF OFFSET</b>
